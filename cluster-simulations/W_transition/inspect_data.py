...
other -- which would mean the disorder realisations are not being varied.
"""
...
parser = argparse.ArgumentParser(description='Sanity-check finished W transition jobs')
